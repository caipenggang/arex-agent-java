...
import io.arex.inst.httpclient.webclient.v2.model.WebClientDefaultResponse;
import io.arex.inst.httpclient.webclient.v2.model.WebClientHttpResponse;
...
public class WebClientAdapter implements HttpClientAdapter<ClientRequest, WebClientResponse> {
    ...
    private String getLogPrefix(ClientRequest request, ClientHttpResponse response) {
        return request.logPrefix() + "[" + UUID.randomUUID() + "] ";
    }
